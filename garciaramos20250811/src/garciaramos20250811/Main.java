...
public class Main {
    ...
    public static int segundoEnUnaHora = 3600;
    ...
    public static void main(String[] args) {
        ...
        //SE ASIGNA EL VALOR DE LAS HORAS A PARTIR DE LOS SEGUNDOS EXCEDENTES DEL CALCULOS DE DIAS
        ...
        //SE ASIGNA EL VALOR DE LOS MINUTOS A PARTIR DE LOS SEGUNDOS RESTANTES DEL
    ...
    public static int calcularDias(int segundosTotales){
        return segundosTotales / (Main.horasEnUnDia * Main.segundoEnUnaHora);
    }
    ...
    public static int calcularHoras (int segundosRestantes){
        return segundosRestantes / Main.segundoEnUnaHora;
    }
